...
class SetInputs:
    ...
    # runs for sensitivities
        ...
        model_runs_with_scenarios_to_combine = {'FWandSAFE-to-Proposal_PriceElas0p4': [model_runs[1], model_runs[2]],
                                                ...
                                                'FWandSAFE_10yrPB': [model_runs[15], model_runs[16]],
                                                'FWandSAFE_aeoH': [model_runs[17], model_runs[18]],
                                                'FWandSAFE_aeoL': [model_runs[19], model_runs[20]],
                                                'FWandSAFE_MassSafety5thPctile': [model_runs[21], model_runs[22]],
                                                'FWandSAFE_MassSafety95thPctile': [model_runs[23], model_runs[24]],
                                                'FWandSAFE_NoHCR2': [model_runs[25], model_runs[26]],
                                                'FWandSAFE_PerfectTrading': [model_runs[27], model_runs[28]],
                                                }
